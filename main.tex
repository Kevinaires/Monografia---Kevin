...
% ---
\titulo{Verificação formal de circuitos lógicos baseado em transformação de código com \textit{Bounded Model Checking}}
...
\renewcommand{\primeiroMembroBanca}{Prof. XXXX}
\renewcommand{\segundoMembroBanca}{Prof. XXXX}
