...
\todo[inline]{se somente a parte final fica em negrito}
...
\todo[inline]{De forma automática}
...
%o método de pesquisa utilizado, mas também, os resultados alcançados com a pesquisa, análise dos artigos e a contribuição dos mesmos para o desenvolvimento do método apresentado neste trabalho\todo{Sugiro reescrever este texto}.
