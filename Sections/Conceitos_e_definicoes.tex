...
\par
\textcolor{red}{O DDB permite o teste eficiente de satisfabilidade, validade e eficiência \cite{kropf2013introduction} e busca aliviar o problema de explosão de dados existente no método de satisfabilidade booleana utilizado nos \textit{model checking}~\cite{baier2008principles}.}
